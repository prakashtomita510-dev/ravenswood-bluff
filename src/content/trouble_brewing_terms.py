...
TROUBLE_BREWING_ROLE_TERMS: dict[str, RoleTerm] = {
    ...
    "fortune_teller": {"role_id": "fortune_teller", "zh_name": "预言家", "en_name": "Fortune Teller", "description": "每晚，你选择两名玩家，得知其中是否至少有一名是恶魔。"},
    ...
    "virgin": {"role_id": "virgin", "zh_name": "圣女", "en_name": "Virgin", "description": "如果你首次被一名村民提名，该提名者会立刻被处决。"},
    "slayer": {"role_id": "slayer", "zh_name": "杀手", "en_name": "Slayer", "description": "每局一次，白天公开选择一名玩家；如果他是恶魔，他立刻死亡。"},
    "soldier": {"role_id": "soldier", "zh_name": "士兵", "en_name": "Soldier", "description": "你不会被恶魔杀死。"},
    "mayor": {"role_id": "mayor", "zh_name": "市长", "en_name": "Mayor", "description": "如果你夜里本会死亡，死亡可能转移给别人；若白天无人被处决，善良阵营可能因此获胜。"},
    ...
    "recluse": {"role_id": "recluse", "zh_name": "隐士", "en_name": "Recluse", "description": "即使你是好人外来者，你也可能被当作邪恶角色、爪牙或恶魔。"},
    ...
    "scarlet_woman": {"role_id": "scarlet_woman", "zh_name": "绯红女郎", "en_name": "Scarlet Woman", "description": "若恶魔死亡且场上有 5 名或更多存活玩家，你立刻成为新的恶魔。"},
